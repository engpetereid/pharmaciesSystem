...
class InvoiceService implements IInvoiceService
{
    ...
    public function update(Invoice $invoice, SaveInvoiceDTO $dto): Invoice
    {
        return DB::transaction(function () use ($invoice, $dto) {
            ...
            foreach ($invoice->items as $oldItem) {
                ...
                $this->warehouseRepository->increment($warehouse,$oldItem->drug_id,$oldItem->quantity);
    ...
    public function delete(Invoice $invoice): bool
    {
        return DB::transaction(function () use ($invoice) {
            ...
            foreach ($invoice->items as $item) {
                ...
                $this->warehouseRepository->increment($warehouse,$item->drug_id,$item->quantity);
    ...
    {
        return $this->invoiceRepository->supervisorInvoices($pharma);
    }
